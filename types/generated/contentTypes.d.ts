...
export interface ApiCompanyPageCompanyPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Career: Schema.Attribute.Component<'company.career', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Cta: Schema.Attribute.Component<'company.cta-section', false>;
    Heads: Schema.Attribute.Component<'company.heads-section', false>;
    Life: Schema.Attribute.Component<'company.life', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Story: Schema.Attribute.Component<'company.story', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Values: Schema.Attribute.Component<'company.values-section', false>;
    Vision: Schema.Attribute.Component<'company.vision-community', false>;
  };
}
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    addressDetails: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    Location: Schema.Attribute.Component<'company.location-section', false>;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Banner: Schema.Attribute.Component<'homepage.banner-section', false>;
    bentoGridSection: Schema.Attribute.Component<
    ...
    carouselSection: Schema.Attribute.Component<
      ...
      false
    >;
    companiesSection: Schema.Attribute.Component<'homepage.companies', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSolutionsPageSolutionsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Aiml: Schema.Attribute.Component<'solutions.aiml-section', false>;
    Cloud: Schema.Attribute.Component<'solutions.cloud-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Cta: Schema.Attribute.Component<'solutions.cta-section', false>;
    CyberSecurity: Schema.Attribute.Component<
      'solutions.cyber-security-section',
      false
    >;
    description: Schema.Attribute.Text;
    EndPoint: Schema.Attribute.Component<'solutions.end-point-section', false>;
    Hpc: Schema.Attribute.Component<'solutions.hpc-section', false>;
    ...
    > &
      Schema.Attribute.Private;
    Network: Schema.Attribute.Component<'solutions.end-point-section', false>;
    Printer: Schema.Attribute.Component<'solutions.printer-section', false>;
    publishedAt: Schema.Attribute.DateTime;
    Storage: Schema.Attribute.Component<'solutions.storage-section', false>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
